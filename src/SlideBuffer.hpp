...
public:
   ...
   ~SlideBuffer() = default;
    ...
    const_range_type kept_range() const
    {
    ...
    iterator       rd_begin()         { return end() - keep();}
    const_iterator rd_begin() const   { return end() - keep();}
    const_iterator rd_cbegin() const  { return end() - keep();}
    ...
    reference rd_front()             { return *rd_begin();}
    const_reference rd_front() const { return *rd_begin();}
