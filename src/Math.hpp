...
template<class T>
constexpr T princarg(T a) { return std::remainder(a, T_TWO_PI<T>);}
template<>
constexpr float  princarg(float a) { return __builtin_remainderf(a, T_TWO_PI<float>);}
...
template<>
constexpr int popcount(uint32_t t) { return __builtin_popcountl(uint32_t(t)); }
template<>
constexpr int popcount(uint16_t t) { return __builtin_popcountl(uint32_t(t)); }
template<>
constexpr int popcount(int32_t t) { return __builtin_popcountl(uint32_t(t)); }
template<>
constexpr int popcount(int16_t t) { return __builtin_popcountl(uint32_t(t)); }
